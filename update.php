...
for($i=1;$i<=$n;$i++)
 ...
 $qid=uniqid();
 $qns=$_POST['qns'.$i];
$q3=mysql_query("INSERT INTO questions VALUES  ('$eid','$qid','$qns' , '$ch' , '$i')");
  $oaid=uniqid();
  $obid=uniqid();
$ocid=uniqid();
$odid=uniqid();
...
$c=$_POST[$i.'3'];
$d=$_POST[$i.'4'];
$qa=mysql_query("INSERT INTO options VALUES  ('$qid','$a','$oaid')") or die('Error61');
$qb=mysql_query("INSERT INTO options VALUES  ('$qid','$b','$obid')") or die('Error62');
$qc=mysql_query("INSERT INTO options VALUES  ('$qid','$c','$ocid')") or die('Error63');
$qd=mysql_query("INSERT INTO options VALUES  ('$qid','$d','$odid')") or die('Error64');
$e=$_POST['ans'.$i];
switch($e)
{
case 'a':
